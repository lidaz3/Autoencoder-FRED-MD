'''
=========================================================================
     Based on Python code by: George Milunovich
           and Matlab code by: Michael W. McCracken and Serena Ng
=========================================================================
'''
...
if __name__ == "__main__":
    # import data
    month = '2022-03' # input
    source = "https://files.stlouisfed.org/files/htdocs/fred-md/monthly/%s.csv"%month
